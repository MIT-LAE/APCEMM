...
double ros_A[15], ros_C[15], ros_M[6], ros_E[6], ros_Alpha[6], ros_Gamma[6],
       ros_ELO;
...
void Jac_SP_Vec( double Jac[], double Fcn[], double K[] );
void JacTR_SP_Vec( double Jac[], double Fcn[], double K[] );
void HessTR_Vec(double Hess[], double U1[], double U2[], double HTU[]);
void KppSolve( double A[], double b[] );
int KppDecomp( double A[] );
void KppSolveTR( double JVS[], double X[], double XX[] );
void Hessian( double V[], double F[], double RCT[], double Hess[] );
