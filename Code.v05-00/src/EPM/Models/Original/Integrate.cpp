...
{
    std::variant<Output, SimStatus> Original::Integrate(
        const Vector_2D& aerArray) {
        Output out;
        ...
        SimStatus returnCode = RunMicrophysics(out, aerArray, delta_T);
    ...
    SimStatus Original::RunMicrophysics(
        Output &state, const Vector_2D& aerArray, double delta_T) {
