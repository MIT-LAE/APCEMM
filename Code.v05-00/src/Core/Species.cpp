...
void SpeciesArray::FillIn( UInt iTime, UInt iRing )
{
    ...
    CO2[iTime][iRing]      = VAR[  0];
    PPN[iTime][iRing]      = VAR[  1];
    BrNO2[iTime][iRing]    = VAR[  2];
    IEPOX[iTime][iRing]    = VAR[  3];
    PMNN[iTime][iRing]     = VAR[  4];
    N2O[iTime][iRing]      = VAR[  5];
    N[iTime][iRing]        = VAR[  6];
    PAN[iTime][iRing]      = VAR[  7];
    ALK4[iTime][iRing]     = VAR[  8];
    MAP[iTime][iRing]      = VAR[  9];
    MPN[iTime][iRing]      = VAR[ 10];
    Cl2O2[iTime][iRing]    = VAR[ 11];
    ETP[iTime][iRing]      = VAR[ 12];
    HNO2[iTime][iRing]     = VAR[ 13];
    C3H8[iTime][iRing]     = VAR[ 14];
    RA3P[iTime][iRing]     = VAR[ 15];
    RB3P[iTime][iRing]     = VAR[ 16];
    OClO[iTime][iRing]     = VAR[ 17];
    ClNO2[iTime][iRing]    = VAR[ 18];
    ISOP[iTime][iRing]     = VAR[ 19];
    HNO4[iTime][iRing]     = VAR[ 20];
    MAOP[iTime][iRing]     = VAR[ 21];
    MP[iTime][iRing]       = VAR[ 22];
    ClOO[iTime][iRing]     = VAR[ 23];
    RP[iTime][iRing]       = VAR[ 24];
    BrCl[iTime][iRing]     = VAR[ 25];
    PP[iTime][iRing]       = VAR[ 26];
    PRPN[iTime][iRing]     = VAR[ 27];
    SO4[iTime][iRing]      = VAR[ 28];
    Br2[iTime][iRing]      = VAR[ 29];
    ETHLN[iTime][iRing]    = VAR[ 30];
    MVKN[iTime][iRing]     = VAR[ 31];
    R4P[iTime][iRing]      = VAR[ 32];
    C2H6[iTime][iRing]     = VAR[ 33];
    RIP[iTime][iRing]      = VAR[ 34];
    VRP[iTime][iRing]      = VAR[ 35];
    ATOOH[iTime][iRing]    = VAR[ 36];
    IAP[iTime][iRing]      = VAR[ 37];
    DHMOB[iTime][iRing]    = VAR[ 38];
    MOBA[iTime][iRing]     = VAR[ 39];
    MRP[iTime][iRing]      = VAR[ 40];
    N2O5[iTime][iRing]     = VAR[ 41];
    ISNOHOO[iTime][iRing]  = VAR[ 42];
    ISNP[iTime][iRing]     = VAR[ 43];
    ISOPNB[iTime][iRing]   = VAR[ 44];
    IEPOXOO[iTime][iRing]  = VAR[ 45];
    MACRNO2[iTime][iRing]  = VAR[ 46];
    ROH[iTime][iRing]      = VAR[ 47];
    MOBAOO[iTime][iRing]   = VAR[ 48];
    DIBOO[iTime][iRing]    = VAR[ 49];
    PMN[iTime][iRing]      = VAR[ 50];
    ISNOOB[iTime][iRing]   = VAR[ 51];
    INPN[iTime][iRing]     = VAR[ 52];
    H[iTime][iRing]        = VAR[ 53];
    BrNO3[iTime][iRing]    = VAR[ 54];
    PRPE[iTime][iRing]     = VAR[ 55];
    MVKOO[iTime][iRing]    = VAR[ 56];
    Cl2[iTime][iRing]      = VAR[ 57];
    ISOPND[iTime][iRing]   = VAR[ 58];
    HOBr[iTime][iRing]     = VAR[ 59];
    A3O2[iTime][iRing]     = VAR[ 60];
    PROPNN[iTime][iRing]   = VAR[ 61];
    GLYX[iTime][iRing]     = VAR[ 62];
    MAOPO2[iTime][iRing]   = VAR[ 63];
    CH4[iTime][iRing]      = VAR[ 64];
    GAOO[iTime][iRing]     = VAR[ 65];
    B3O2[iTime][iRing]     = VAR[ 66];
    ACET[iTime][iRing]     = VAR[ 67];
    MACRN[iTime][iRing]    = VAR[ 68];
    CH2OO[iTime][iRing]    = VAR[ 69];
    MGLYOO[iTime][iRing]   = VAR[ 70];
    VRO2[iTime][iRing]     = VAR[ 71];
    MGLOO[iTime][iRing]    = VAR[ 72];
    MACROO[iTime][iRing]   = VAR[ 73];
    PO2[iTime][iRing]      = VAR[ 74];
    CH3CHOO[iTime][iRing]  = VAR[ 75];
    MAN2[iTime][iRing]     = VAR[ 76];
    ISNOOA[iTime][iRing]   = VAR[ 77];
    H2O2[iTime][iRing]     = VAR[ 78];
    PRN1[iTime][iRing]     = VAR[ 79];
    ETO2[iTime][iRing]     = VAR[ 80];
    KO2[iTime][iRing]      = VAR[ 81];
    RCO3[iTime][iRing]     = VAR[ 82];
    HC5OO[iTime][iRing]    = VAR[ 83];
    GLYC[iTime][iRing]     = VAR[ 84];
    ClNO3[iTime][iRing]    = VAR[ 85];
    RIO2[iTime][iRing]     = VAR[ 86];
    R4N1[iTime][iRing]     = VAR[ 87];
    HOCl[iTime][iRing]     = VAR[ 88];
    ATO2[iTime][iRing]     = VAR[ 89];
    HNO3[iTime][iRing]     = VAR[ 90];
    ISN1[iTime][iRing]     = VAR[ 91];
    MAO3[iTime][iRing]     = VAR[ 92];
    MRO2[iTime][iRing]     = VAR[ 93];
    INO2[iTime][iRing]     = VAR[ 94];
    HAC[iTime][iRing]      = VAR[ 95];
    HC5[iTime][iRing]      = VAR[ 96];
    MGLY[iTime][iRing]     = VAR[ 97];
    ISOPNBO2[iTime][iRing] = VAR[ 98];
    ISOPNDO2[iTime][iRing] = VAR[ 99];
    R4O2[iTime][iRing]     = VAR[100];
    R4N2[iTime][iRing]     = VAR[101];
    BrO[iTime][iRing]      = VAR[102];
    RCHO[iTime][iRing]     = VAR[103];
    MEK[iTime][iRing]      = VAR[104];
    ClO[iTime][iRing]      = VAR[105];
    MACR[iTime][iRing]     = VAR[106];
    SO2[iTime][iRing]      = VAR[107];
    MVK[iTime][iRing]      = VAR[108];
    ALD2[iTime][iRing]     = VAR[109];
    MCO3[iTime][iRing]     = VAR[110];
    CH2O[iTime][iRing]     = VAR[111];
    H2O[iTime][iRing]      = VAR[112];
    Br[iTime][iRing]       = VAR[113];
    NO[iTime][iRing]       = VAR[114];
    NO3[iTime][iRing]      = VAR[115];
    Cl[iTime][iRing]       = VAR[116];
    O[iTime][iRing]        = VAR[117];
    O1D[iTime][iRing]      = VAR[118];
    O3[iTime][iRing]       = VAR[119];
    HO2[iTime][iRing]      = VAR[120];
    NO2[iTime][iRing]      = VAR[121];
    OH[iTime][iRing]       = VAR[122];
    HBr[iTime][iRing]      = VAR[123];
    HCl[iTime][iRing]      = VAR[124];
    CO[iTime][iRing]       = VAR[125];
    MO2[iTime][iRing]      = VAR[126];
...
void SpeciesArray::getData( UInt iTime, UInt iRing )
{
    ...
    VAR[  0] = CO2[iTime][iRing];
    VAR[  1] = PPN[iTime][iRing];
    VAR[  2] = BrNO2[iTime][iRing];
    VAR[  3] = IEPOX[iTime][iRing];
    VAR[  4] = PMNN[iTime][iRing];
    VAR[  5] = N2O[iTime][iRing];
    VAR[  6] = N[iTime][iRing];
    VAR[  7] = PAN[iTime][iRing];
    VAR[  8] = ALK4[iTime][iRing];
    VAR[  9] = MAP[iTime][iRing];
    VAR[ 10] = MPN[iTime][iRing];
    VAR[ 11] = Cl2O2[iTime][iRing];
    VAR[ 12] = ETP[iTime][iRing];
    VAR[ 13] = HNO2[iTime][iRing];
    VAR[ 14] = C3H8[iTime][iRing];
    VAR[ 15] = RA3P[iTime][iRing];
    VAR[ 16] = RB3P[iTime][iRing];
    VAR[ 17] = OClO[iTime][iRing];
    VAR[ 18] = ClNO2[iTime][iRing];
    VAR[ 19] = ISOP[iTime][iRing];
    VAR[ 20] = HNO4[iTime][iRing];
    VAR[ 21] = MAOP[iTime][iRing];
    VAR[ 22] = MP[iTime][iRing];
    VAR[ 23] = ClOO[iTime][iRing];
    VAR[ 24] = RP[iTime][iRing];
    VAR[ 25] = BrCl[iTime][iRing];
    VAR[ 26] = PP[iTime][iRing];
    VAR[ 27] = PRPN[iTime][iRing];
    VAR[ 28] = SO4[iTime][iRing];
    VAR[ 29] = Br2[iTime][iRing];
    VAR[ 30] = ETHLN[iTime][iRing];
    VAR[ 31] = MVKN[iTime][iRing];
    VAR[ 32] = R4P[iTime][iRing];
    VAR[ 33] = C2H6[iTime][iRing];
    VAR[ 34] = RIP[iTime][iRing];
    VAR[ 35] = VRP[iTime][iRing];
    VAR[ 36] = ATOOH[iTime][iRing];
    VAR[ 37] = IAP[iTime][iRing];
    VAR[ 38] = DHMOB[iTime][iRing];
    VAR[ 39] = MOBA[iTime][iRing];
    VAR[ 40] = MRP[iTime][iRing];
    VAR[ 41] = N2O5[iTime][iRing];
    VAR[ 42] = ISNOHOO[iTime][iRing];
    VAR[ 43] = ISNP[iTime][iRing];
    VAR[ 44] = ISOPNB[iTime][iRing];
    VAR[ 45] = IEPOXOO[iTime][iRing];
    VAR[ 46] = MACRNO2[iTime][iRing];
    VAR[ 47] = ROH[iTime][iRing];
    VAR[ 48] = MOBAOO[iTime][iRing];
    VAR[ 49] = DIBOO[iTime][iRing];
    VAR[ 50] = PMN[iTime][iRing];
    VAR[ 51] = ISNOOB[iTime][iRing];
    VAR[ 52] = INPN[iTime][iRing];
    VAR[ 53] = H[iTime][iRing];
    VAR[ 54] = BrNO3[iTime][iRing];
    VAR[ 55] = PRPE[iTime][iRing];
    VAR[ 56] = MVKOO[iTime][iRing];
    VAR[ 57] = Cl2[iTime][iRing];
    VAR[ 58] = ISOPND[iTime][iRing];
    VAR[ 59] = HOBr[iTime][iRing];
    VAR[ 60] = A3O2[iTime][iRing];
    VAR[ 61] = PROPNN[iTime][iRing];
    VAR[ 62] = GLYX[iTime][iRing];
    VAR[ 63] = MAOPO2[iTime][iRing];
    VAR[ 64] = CH4[iTime][iRing];
    VAR[ 65] = GAOO[iTime][iRing];
    VAR[ 66] = B3O2[iTime][iRing];
    VAR[ 67] = ACET[iTime][iRing];
    VAR[ 68] = MACRN[iTime][iRing];
    VAR[ 69] = CH2OO[iTime][iRing];
    VAR[ 70] = MGLYOO[iTime][iRing];
    VAR[ 71] = VRO2[iTime][iRing];
    VAR[ 72] = MGLOO[iTime][iRing];
    VAR[ 73] = MACROO[iTime][iRing];
    VAR[ 74] = PO2[iTime][iRing];
    VAR[ 75] = CH3CHOO[iTime][iRing];
    VAR[ 76] = MAN2[iTime][iRing];
    VAR[ 77] = ISNOOA[iTime][iRing];
    VAR[ 78] = H2O2[iTime][iRing];
    VAR[ 79] = PRN1[iTime][iRing];
    VAR[ 80] = ETO2[iTime][iRing];
    VAR[ 81] = KO2[iTime][iRing];
    VAR[ 82] = RCO3[iTime][iRing];
    VAR[ 83] = HC5OO[iTime][iRing];
    VAR[ 84] = GLYC[iTime][iRing];
    VAR[ 85] = ClNO3[iTime][iRing];
    VAR[ 86] = RIO2[iTime][iRing];
    VAR[ 87] = R4N1[iTime][iRing];
    VAR[ 88] = HOCl[iTime][iRing];
    VAR[ 89] = ATO2[iTime][iRing];
    VAR[ 90] = HNO3[iTime][iRing];
    VAR[ 91] = ISN1[iTime][iRing];
    VAR[ 92] = MAO3[iTime][iRing];
    VAR[ 93] = MRO2[iTime][iRing];
    VAR[ 94] = INO2[iTime][iRing];
    VAR[ 95] = HAC[iTime][iRing];
    VAR[ 96] = HC5[iTime][iRing];
    VAR[ 97] = MGLY[iTime][iRing];
    VAR[ 98] = ISOPNBO2[iTime][iRing];
    VAR[ 99] = ISOPNDO2[iTime][iRing];
    VAR[100] = R4O2[iTime][iRing];
    VAR[101] = R4N2[iTime][iRing];
    VAR[102] = BrO[iTime][iRing];
    VAR[103] = RCHO[iTime][iRing];
    VAR[104] = MEK[iTime][iRing];
    VAR[105] = ClO[iTime][iRing];
    VAR[106] = MACR[iTime][iRing];
    VAR[107] = SO2[iTime][iRing];
    VAR[108] = MVK[iTime][iRing];
    VAR[109] = ALD2[iTime][iRing];
    VAR[110] = MCO3[iTime][iRing];
    VAR[111] = CH2O[iTime][iRing];
    VAR[112] = H2O[iTime][iRing];
    VAR[113] = Br[iTime][iRing];
    VAR[114] = NO[iTime][iRing];
    VAR[115] = NO3[iTime][iRing];
    VAR[116] = Cl[iTime][iRing];
    VAR[117] = O[iTime][iRing];
    VAR[118] = O1D[iTime][iRing];
    VAR[119] = O3[iTime][iRing];
    VAR[120] = HO2[iTime][iRing];
    VAR[121] = NO2[iTime][iRing];
    VAR[122] = OH[iTime][iRing];
    VAR[123] = HBr[iTime][iRing];
    VAR[124] = HCl[iTime][iRing];
    VAR[125] = CO[iTime][iRing];
    VAR[126] = MO2[iTime][iRing];
    FIX[  0] = ACTA;
    FIX[  1] = EOH;
    FIX[  2] = H2;
    FIX[  3] = HCOOH;
