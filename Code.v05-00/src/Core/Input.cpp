...
Input::Input( unsigned int iCase,          \
    ...
    pressure_Pa_   ( parameters[ 5][iCase] ),
    emissionDOY_   ( parameters[ 6][iCase] ),
    emissionTime_  ( parameters[ 7][iCase] ),
    EI_NOx_        ( parameters[ 8][iCase] ),
    EI_CO_         ( parameters[ 9][iCase] ),
    EI_HC_         ( parameters[10][iCase] ),
    EI_SO2_        ( parameters[11][iCase] ),
    EI_SO2TOSO4_   ( parameters[12][iCase] ),
    EI_Soot_       ( parameters[13][iCase] ),
    sootRad_       ( parameters[14][iCase] ),
    fuelFlow_      ( parameters[15][iCase] ),
    backgNOx_      ( parameters[16][iCase] ),
    backgHNO3_     ( parameters[17][iCase] ),
    backgO3_       ( parameters[18][iCase] ),
    backgCO_       ( parameters[19][iCase] ),
    backgCH4_      ( parameters[20][iCase] ),
    backgSO2_      ( parameters[21][iCase] ),
    fileName_      ( fileName ),
